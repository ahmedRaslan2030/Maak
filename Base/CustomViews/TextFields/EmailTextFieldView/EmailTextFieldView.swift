...
//  Msuom
//
//  Created by Ahmed Raslan on 23/10/2023.
//
...
class EmailTextFieldView: TextFieldView {
    ...
    private func setupLocalization() {
        self.titleLabel.text = "E-mail Address".emailTitleLocalizable
        self.textField.placeholder = "Please enter your e-mail address".emailTitleLocalizable
    }
