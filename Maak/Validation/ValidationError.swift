...
enum ValidationError: Error {
    ...
    case emptyProviderType
    
    //MARK: - Services -
    case emptyService(serviceTitle: String)

    //MARK: - OrderNotes -
    case emptyOrderNotes
    case shouldNotContainPhoneNumber
    
    //MARK: - OrderImages -
     case emptyOrderImages
...
extension ValidationError: LocalizedError {
    var errorDescription: String? {
        ...
        //MARK: - Avatar -
        case .emptyAvatar:
            return "Please select personal profile".validationLocalized
            //MARK: - User Name -

        case .emptyUserName:
            return "Please enter user name.".validationLocalized
        case .shortUserName:
            return "User name is too short.".validationLocalized
        case .longUserName:
            return "User name is too long.".validationLocalized
            //MARK: - Nationality -
        case .emptyNationality:
            return "Please enter nationality field.".validationLocalized
        ...
        case .emptyRegion:
            return "Please select region.".validationLocalized
        ...
        case .emptyLocation:
            return "Please select the current location.".validationLocalized
            
        case .emptyDestinationLocation:
            return "Please select the destination location.".validationLocalized
        case .emptyAddressDetails:
        ...
        case .emptyDate:
            ...
            //MARK: - Time -
        case .emptyTime:
            return "Please select the time.".validationLocalized
        ...
        case .emptyDescription:
            ...
            //MARK: - Employee -
        case .emptyEmployee:
            return "Please choose the employee".validationLocalized
            
            //MARK: - Payment -
            
        case .emptyPaymentMethod:
            return "Please choose the payment method".validationLocalized

            //MARK: - Cancel Reason -

        case .cancelReason:
            return "Please enter cancel reason".validationLocalized
            
            
            //MARK: - Rating -

        case .emptyRating:
            return "Please enter your rating".validationLocalized
            
            
        case .emptyComment:
            return "Please enter your comment".validationLocalized
            
            //MARK: - Create Order -
            
        case .emptyProviderType:
            return "Please choose provider type".validationLocalized

        case let .emptyService(serviceTitle):
            return "Please fill".validationLocalized + " \((serviceTitle)))" + "options".validationLocalized
            
            
        case .emptyOrderNotes:
            return "Please enter order notes".validationLocalized
            
        case .shouldNotContainPhoneNumber:
            return "Order notes should't contain phone number".validationLocalized

            
        case .emptyOrderImages:
            return "Please add order images.".validationLocalized
        }
